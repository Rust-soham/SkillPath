...
.sp-field,.sp-button,.sp-note button{font-family:inherit}.sp-field{font-size:14px;font-weight:500}.sp-note button{margin-left:6px;padding:3px 9px;border:1px solid var(--accent);border-radius:3px;color:var(--ink);background:#fff;font-size:13px;font-weight:600;line-height:1.1;cursor:pointer}
`
